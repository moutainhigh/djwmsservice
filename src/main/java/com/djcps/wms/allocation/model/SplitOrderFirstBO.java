 ...
 * @date:2018年4月18日
 */
public class SplitOrderFirstBO extends PartnerInfoBO implements Serializable{
	
	private static final long serialVersionUID = 5352680264165377722L;
	...
	public void setFirstOrderStatus(Integer firstOrderStatus) {
		this.firstOrderStatus = firstOrderStatus;
	}
	public Integer getFirstIsSplit() {
		return firstIsSplit;
	}
	public void setFirstIsSplit(Integer firstIsSplit) {
		this.firstIsSplit = firstIsSplit;
	}
	...
	public String toString() {
		return "SplitOrderFirstBO [firstOrder=" + firstOrder + ", firstOrderStatus=" + firstOrderStatus
				+ ", firstIsSplit=" + firstIsSplit + ", firstOrderAmount=" + firstOrderAmount + ", waybillId="
